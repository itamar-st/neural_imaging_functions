function binned_data = tm_plotsp(data, xbin, ybin, xsize, ysize, hold,points)
...
if (nargin >= 3),	% called from command line with at least 3 args
    ...
    elseif (nargin > 7); help tm_plotsp; return;
    end;
    ...
    if hold
        ...
        puttitle_h = uicontrol('Style','pushbutton',...
            ...
            'ForegroundColor', [1 1 0],...
            'Callback', 'plotsp(5)');
        figroi_h  = uicontrol('Style','pushbutton',...
            'Units','normalized', 'Position',[.95 .64 .04 .04],...
            'String', 'ROI',...
            'BackgroundColor', [0 .5 0],...
            'ForegroundColor', [1 1 0],...
            'Callback', 'roiaxis');
    ...
    for i=1:nplots
        ...
        plot(points,trace(points),'r*','MarkerSize',3)
        binned_data(i,:) = trace;
    end
